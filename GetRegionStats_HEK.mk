...
bin/GetRegionStats_HEK.x : GetRegionStats_HEK.mk objects/GetRegionStats_HEK.o objects/FeatureVector.o objects/Coordinate.o objects/RegionStats.o objects/Region.o objects/MainUtilities.o objects/ArgumentHelper.o objects/SunImage.o objects/Image.o objects/tools.o
	$(CC) $(CFLAGS) $(DFLAGS) objects/GetRegionStats_HEK.o objects/FeatureVector.o objects/Coordinate.o objects/RegionStats.o objects/Region.o objects/MainUtilities.o objects/ArgumentHelper.o objects/SunImage.o objects/Image.o objects/tools.o $(LFLAGS) -o bin/GetRegionStats_HEK.x

objects/GetRegionStats_HEK.o : GetRegionStats_HEK.mk programs/GetRegionStats_HEK.cpp classes/tools.h classes/constants.h classes/SunImage.h dsr/ArgumentHelper.h classes/MainUtilities.h classes/RegionStats.h classes/Coordinate.h classes/FeatureVector.h
...
objects/MainUtilities.o : GetRegionStats_HEK.mk classes/MainUtilities.cpp classes/FeatureVector.h classes/SunImage.h
