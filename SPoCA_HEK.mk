...
all:bin/SPoCA_HEK.x
clean: rm bin/SPoCA_HEK.x objects/SPoCA_HEK.o objects/MainUtilities.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/ArgumentHelper.o objects/FeatureVector.o objects/HistogramPCMClassifier.o objects/PCMClassifier.o objects/FCMClassifier.o objects/Classifier.o objects/Coordinate.o objects/Region.o objects/Image.o objects/HistogramPCM2Classifier.o objects/PCM2Classifier.o objects/HistogramFCMClassifier.o objects/HistogramClassifier.o objects/SunImage.o objects/tools.o


bin/SPoCA_HEK.x : SPoCA_HEK.mk objects/SPoCA_HEK.o objects/MainUtilities.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/ArgumentHelper.o objects/FeatureVector.o objects/HistogramPCMClassifier.o objects/PCMClassifier.o objects/FCMClassifier.o objects/Classifier.o objects/Coordinate.o objects/Region.o objects/Image.o objects/HistogramPCM2Classifier.o objects/PCM2Classifier.o objects/HistogramFCMClassifier.o objects/HistogramClassifier.o objects/SunImage.o objects/tools.o
	$(CC) $(CFLAGS) $(DFLAGS) objects/SPoCA_HEK.o objects/MainUtilities.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/ArgumentHelper.o objects/FeatureVector.o objects/HistogramPCMClassifier.o objects/PCMClassifier.o objects/FCMClassifier.o objects/Classifier.o objects/Coordinate.o objects/Region.o objects/Image.o objects/HistogramPCM2Classifier.o objects/PCM2Classifier.o objects/HistogramFCMClassifier.o objects/HistogramClassifier.o objects/SunImage.o objects/tools.o $(LFLAGS) -o bin/SPoCA_HEK.x

objects/SPoCA_HEK.o : SPoCA_HEK.mk programs/SPoCA_HEK.cpp classes/tools.h classes/constants.h classes/SunImage.h classes/HistogramFCMClassifier.h classes/HistogramPCM2Classifier.h classes/HistogramPCMClassifier.h classes/FeatureVector.h classes/ArgumentHelper.h classes/MainUtilities.h
