...
bin/SPoCA_HEK.x : SPoCA_HEK.mk objects/SPoCA_HEK.o objects/Coordinate.o objects/MainUtilities.o objects/ArgumentHelper.o objects/FeatureVector.o objects/HistogramFCMClassifier.o objects/FCMClassifier.o objects/Classifier.o objects/RegionStats.o objects/Region.o objects/Image.o objects/SunImage.o objects/tools.o
	$(CC) $(CFLAGS) $(DFLAGS) objects/SPoCA_HEK.o objects/Coordinate.o objects/MainUtilities.o objects/ArgumentHelper.o objects/FeatureVector.o objects/HistogramFCMClassifier.o objects/FCMClassifier.o objects/Classifier.o objects/RegionStats.o objects/Region.o objects/Image.o objects/SunImage.o objects/tools.o $(LFLAGS) -o bin/SPoCA_HEK.x

objects/SPoCA_HEK.o : SPoCA_HEK.mk programs/SPoCA_HEK.cpp classes/tools.h classes/constants.h classes/SunImage.h classes/HistogramFCMClassifier.h classes/FeatureVector.h dsr/ArgumentHelper.h classes/MainUtilities.h classes/Coordinate.h
