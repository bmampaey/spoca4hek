...
#define BAD_WCS_VAL       502					  /* bad celestial c or pixel value */
#define WCS_ERROR         503					  /* error in celestial c calculation */
#define BAD_WCS_PROJ      504					  /* unsupported type of celestial projection */
#define NO_WCS_KEY        505					  /* celestial c keywords not found */
...
extern "C"
{
	...
	int fits_copy_image2cell(fitsfile *fptr, fitsfile *newptr, char *colname,
		long rownum, int copykeyflag, int *status);
												  /* I - first HDU record number to start with */
