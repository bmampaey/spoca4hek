...
bin/Tracking_HEK.x : Tracking_HEK.mk objects/Tracking_HEK.o objects/MainUtilities.o objects/FeatureVector.o objects/ArgumentHelper.o objects/Region.o objects/SunImage.o objects/Image.o objects/tools.o
	$(CC) $(CFLAGS) $(DFLAGS) objects/Tracking_HEK.o objects/MainUtilities.o objects/FeatureVector.o objects/ArgumentHelper.o objects/Region.o objects/SunImage.o objects/Image.o objects/tools.o $(LFLAGS) -o bin/Tracking_HEK.x
...
objects/tools.o : Tracking_HEK.mk classes/tools.cpp classes/constants.h classes/Coordinate.h
