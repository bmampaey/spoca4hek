...
DFLAGS=-DHEK -DNUMBERCHANNELS=1

all:bin/tracking.x
clean: rm bin/tracking.x objects/tracking.o objects/Header.o objects/FitsFile.o objects/Coordinate.o objects/trackable.o objects/Region.o objects/ColorMap.o objects/SunImage.o objects/WCS.o objects/Image.o objects/ArgumentHelper.o objects/mainutilities.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/EUVImage.o objects/FeatureVector.o objects/tools.o


bin/tracking.x : tracking.mk objects/tracking.o objects/Header.o objects/FitsFile.o objects/Coordinate.o objects/trackable.o objects/Region.o objects/ColorMap.o objects/SunImage.o objects/WCS.o objects/Image.o objects/ArgumentHelper.o objects/mainutilities.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/EUVImage.o objects/FeatureVector.o objects/tools.o
	$(CC) $(CFLAGS) $(DFLAGS) objects/tracking.o objects/Header.o objects/FitsFile.o objects/Coordinate.o objects/trackable.o objects/Region.o objects/ColorMap.o objects/SunImage.o objects/WCS.o objects/Image.o objects/ArgumentHelper.o objects/mainutilities.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/EUVImage.o objects/FeatureVector.o objects/tools.o $(LFLAGS) -o bin/tracking.x
...
objects/FitsFile.o : tracking.mk classes/FitsFile.cpp classes/fitsio.h classes/longnam.h classes/tools.h classes/constants.h classes/Header.h classes/Coordinate.h
	$(CC) -c $(CFLAGS) $(DFLAGS) classes/FitsFile.cpp -o objects/FitsFile.o

objects/Coordinate.o : tracking.mk classes/Coordinate.cpp classes/constants.h
...
objects/Region.o : tracking.mk classes/Region.cpp classes/constants.h classes/tools.h classes/Coordinate.h classes/ColorMap.h classes/FitsFile.h
...
objects/SunImage.o : tracking.mk classes/SunImage.cpp classes/Image.h classes/WCS.h classes/Header.h classes/Coordinate.h classes/FitsFile.h
	$(CC) -c $(CFLAGS) $(DFLAGS) classes/SunImage.cpp -o objects/SunImage.o

objects/WCS.o : tracking.mk classes/WCS.cpp classes/constants.h classes/Coordinate.h classes/FitsFile.h
